...
public:
    ...
    T Calculate(int n, NoSortedTable1 A, NoSortedTable2 B, SortedTable C, HashTable1 D, HashTable2 G, TreeTable E) { // Ввод переменных, вычисление по постфиксной форме
